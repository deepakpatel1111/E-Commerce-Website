        ...
        <form action="RegisterServlet" method="post">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
             ...
             <input name="user_email" type="email" class="form-control" id="n" placeholder="Enter Email">
           </div>
         ...
         <div class="form-group">
             ...
             <textarea name="user_address" style="height: 200px;" class="form-control" id="address" placeholder="Enter Address"></textarea>
         </div>
