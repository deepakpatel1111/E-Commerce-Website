...
<h1>Wwelcome Deepak</h1>
			...
			<!-- first col -->
			 ...
			 <div class="card">
			 		<div class="card-body text-center" >
			 			...
			 			<div class="container">
			 			<img style="max-width:125px" class="img-fluid" src="img/delivery-box.png" alt="product_icon">
			 		</div>
				 ...
				 <div class="col-md-6">
				  ...
				  <div class="card"  data-toggle="modal" data-target="#add_category_modal">
			 		<div class="card-body text-center" >
			 			...
			 			<div class="container">
			 			<img style="max-width:125px" class="img-fluid" src="img/plus.png" alt="product_icon">
			 		</div>
				  ...
				  <div class="card"  data-toggle="modal" data-target="#add_product_modal">
			 		<div class="card-body text-center" >
			 		
			 			<div class="container">
			 			<img style="max-width:125px" class="img-fluid" src="img/add-product.png" alt="product_icon">
			 		</div>
			 		<h1> Add Product</h1>
			 		</div>
			 	</div>
		...
		<div class="modal fade" id="add_product_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		       <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
		        	...
		        	<div class="form-group">
		        	<textarea style="height:200px" class="form-control" placeholder="Enter product description " name="productDescription" required></textarea>
		        	</div>
		        	
		        	
		        	
		        	<div class="form-group">
		        				<label for="pPic">Choose product photo</label>
					        	<input type="file" id="pPic" name="pPic" class="form-control" placeholder="Choose product photo" name="productPhoto" accept="image/png, image/jpeg">
		        	</div>
		        	
		        	
		        
		        	<div class="form-group">
		        	<textarea class="form-control" placeholder="Enter product price " name="productPrice" required></textarea>
		        	</div>
		        	...
		        	<div class="form-group">
		        	<textarea class="form-control" placeholder="Enter product discount " name="productDiscount" required></textarea>
		        	</div>
		        	
		        	
		        	<div class="form-group">
		        	<textarea class="form-control" placeholder="Enter product quantity " name="productQuantity" required></textarea>
		        	</div>
			...
			<!-- 	
				productName, String productDescription, String productPhoto,
